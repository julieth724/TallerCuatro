...
public class Cars extends Vehicle {
     ...
     */
    public Cars(String listNumPassengers, String ynCrew, String regDate, String displacementMed, String numberDoors, String licensePlate, String numWheels) {
        super(listNumPassengers, ynCrew, regDate, displacementMed, "Car");
    ...
    public static Cars createCars() {
        try {
                ...
                System.out.println("---------------------------------------------------------");
                System.out.println("please, entering the number License Plat the your vehicle");
                System.out.println("-------------------------------------------------------------");
                ...
                Cars car = new Cars(numPassengersStr, newCrewStr, newRegDate, newDisplacementMedium, newNumberDoors, newLicensePlate, newNumWheels);
                return car;
